      ...
      <div class="tab-content">
        <div class="tab-pane">
          <div class="floor-1">
            <div class="blockgary">
              <ul class="jd-list">
                <li v-for="(content,index) in floor.keywords" :key="index">{{ content }}</li>
                <!--                <li>4K电视</li>
                                <li>空气净化器</li>
                                <li>IH电饭煲</li>
                                <li>滚筒洗衣机</li>
                ...
                <div class="swiper-wrapper">
                  ...
                  <div class="swiper-slide">
                    <div class="swiper-slide animate__animated  animate__backInUp">
                      ...
                      <el-carousel :interval="8000" arrow="always" height="360px">
                        <el-carousel-item v-for="(c1,index) in floor.carouselList" :key="c1.id">
